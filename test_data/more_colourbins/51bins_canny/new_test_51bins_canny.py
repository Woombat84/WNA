...
def colorBin(img,lst):
    ...
    low1 = np.array([0, 0, 30])
    high1 = np.array([10, 29, 255])
    bin1_mask = cv2.inRange(img, low1, high1)
    lst.append(cv2.countNonZero(bin1_mask))

    low2 = np.array([11, 0, 30])
    high2 = np.array([20, 29, 255])
    bin2_mask = cv2.inRange(img, low2, high2)
    lst.append(cv2.countNonZero(bin2_mask))

    low3 = np.array([21, 0, 30])
    high3 = np.array([30, 29, 255])
    bin3_mask = cv2.inRange(img, low3, high3)
    lst.append(cv2.countNonZero(bin3_mask))

    low4 = np.array([41, 0, 30])
    high4 = np.array([50, 29, 255])
    bin4_mask = cv2.inRange(img, low4, high4)
    lst.append(cv2.countNonZero(bin4_mask))

    low5 = np.array([51, 0, 30])
    high5 = np.array([60, 29, 255])
    bin5_mask = cv2.inRange(img, low5, high5)
    lst.append(cv2.countNonZero(bin5_mask))

    low6 = np.array([61, 0, 30])
    high6 = np.array([70, 29, 255])
    bin6_mask = cv2.inRange(img, low6, high6)
    lst.append(cv2.countNonZero(bin6_mask))

    low7 = np.array([71, 0, 30])
    high7 = np.array([80, 29, 255])
    bin7_mask = cv2.inRange(img, low7, high7)
    lst.append(cv2.countNonZero(bin7_mask))

    low8 = np.array([81, 0, 30])
    high8 = np.array([90, 29, 255])
    bin8_mask = cv2.inRange(img, low8, high8)
    lst.append(cv2.countNonZero(bin8_mask))

    low9 = np.array([91, 0, 30])
    high9 = np.array([100, 29, 255])
    bin9_mask = cv2.inRange(img, low9, high9)
    lst.append(cv2.countNonZero(bin9_mask))

    low10 = np.array([101, 0, 30])
    high10 = np.array([110, 29, 255])
    bin10_mask = cv2.inRange(img, low10, high10)
    lst.append(cv2.countNonZero(bin10_mask))

    low11 = np.array([111, 0, 30])
    high11 = np.array([120, 29, 255])
    bin11_mask = cv2.inRange(img, low11, high11)
    lst.append(cv2.countNonZero(bin11_mask))

    low12 = np.array([121, 0, 30])
    high12 = np.array([130, 29, 255])
    bin12_mask = cv2.inRange(img, low12, high12)
    lst.append( cv2.countNonZero(bin12_mask))

    low13 = np.array([131, 0, 30])
    high13 = np.array([140, 29, 255])
    bin13_mask = cv2.inRange(img, low13, high13)
    lst.append(cv2.countNonZero(bin13_mask))

    low14 = np.array([141, 0, 30])
    high14 = np.array([150, 29, 255])
    bin14_mask = cv2.inRange(img, low14, high14)
    lst.append(cv2.countNonZero(bin14_mask))

    low15 = np.array([151, 0, 30])
    high15 = np.array([160, 29, 255])
    bin15_mask = cv2.inRange(img, low15, high15)
    lst.append(cv2.countNonZero(bin15_mask))

    low16 = np.array([161, 0, 30])
    high16 = np.array([170, 29, 255])
    bin16_mask = cv2.inRange(img, low16, high16)
    lst.append(cv2.countNonZero(bin16_mask))

    low17 = np.array([171, 0, 30])
    high17 = np.array([179, 29, 255])
    bin17_mask = cv2.inRange(img, low17, high17)
    lst.append(cv2.countNonZero(bin17_mask))

    low1 = np.array([0, 30, 0])
    high1 = np.array([10, 255, 29])
    bin1_mask = cv2.inRange(img, low1, high1)
    lst.append(cv2.countNonZero(bin1_mask))

    low2 = np.array([11, 30, 0])
    high2 = np.array([20, 255, 29])
    bin2_mask = cv2.inRange(img, low2, high2)
    lst.append(cv2.countNonZero(bin2_mask))

    low3 = np.array([21, 30, 0])
    high3 = np.array([30, 255, 29])
    bin3_mask = cv2.inRange(img, low3, high3)
    lst.append(cv2.countNonZero(bin3_mask))

    low4 = np.array([41, 30, 0])
    high4 = np.array([50, 255, 29])
    bin4_mask = cv2.inRange(img, low4, high4)
    lst.append(cv2.countNonZero(bin4_mask))

    low5 = np.array([51, 30, 0])
    high5 = np.array([60, 255, 29])
    bin5_mask = cv2.inRange(img, low5, high5)
    lst.append(cv2.countNonZero(bin5_mask))

    low6 = np.array([61, 30, 0])
    high6 = np.array([70, 255, 29])
    bin6_mask = cv2.inRange(img, low6, high6)
    lst.append(cv2.countNonZero(bin6_mask))

    low7 = np.array([71, 30, 0])
    high7 = np.array([80, 255, 29])
    bin7_mask = cv2.inRange(img, low7, high7)
    lst.append(cv2.countNonZero(bin7_mask))

    low8 = np.array([81, 30, 0])
    high8 = np.array([90, 255, 29])
    bin8_mask = cv2.inRange(img, low8, high8)
    lst.append(cv2.countNonZero(bin8_mask))

    low9 = np.array([91, 30, 0])
    high9 = np.array([100, 255, 29])
    bin9_mask = cv2.inRange(img, low9, high9)
    lst.append(cv2.countNonZero(bin9_mask))

    low10 = np.array([101, 30, 0])
    high10 = np.array([110, 255, 29])
    bin10_mask = cv2.inRange(img, low10, high10)
    lst.append(cv2.countNonZero(bin10_mask))

    low11 = np.array([111, 30, 0])
    high11 = np.array([120, 255, 29])
    bin11_mask = cv2.inRange(img, low11, high11)
    lst.append(cv2.countNonZero(bin11_mask))

    low12 = np.array([121, 30, 0])
    high12 = np.array([130, 255, 29])
    bin12_mask = cv2.inRange(img, low12, high12)
    lst.append( cv2.countNonZero(bin12_mask))

    low13 = np.array([131, 30, 0])
    high13 = np.array([140, 255, 29])
    bin13_mask = cv2.inRange(img, low13, high13)
    lst.append(cv2.countNonZero(bin13_mask))

    low14 = np.array([141, 30, 0])
    high14 = np.array([150, 255, 29])
    bin14_mask = cv2.inRange(img, low14, high14)
    lst.append(cv2.countNonZero(bin14_mask))

    low15 = np.array([151, 30, 0])
    high15 = np.array([160, 255, 29])
    bin15_mask = cv2.inRange(img, low15, high15)
    lst.append(cv2.countNonZero(bin15_mask))

    low16 = np.array([161, 30, 0])
    high16 = np.array([170, 255, 29])
    bin16_mask = cv2.inRange(img, low16, high16)
    lst.append(cv2.countNonZero(bin16_mask))

    low17 = np.array([171, 30, 0])
    high17 = np.array([179, 255, 29])
    bin17_mask = cv2.inRange(img, low17, high17)
    lst.append(cv2.countNonZero(bin17_mask))

    low1 = np.array([0, 0, 0])
    high1 = np.array([10, 29, 29])
    bin1_mask = cv2.inRange(img, low1, high1)
    lst.append(cv2.countNonZero(bin1_mask))

    low2 = np.array([11, 0, 0])
    high2 = np.array([20, 29, 29])
    bin2_mask = cv2.inRange(img, low2, high2)
    lst.append(cv2.countNonZero(bin2_mask))

    low3 = np.array([21, 0, 0])
    high3 = np.array([30, 29, 29])
    bin3_mask = cv2.inRange(img, low3, high3)
    lst.append(cv2.countNonZero(bin3_mask))

    low4 = np.array([41, 0, 0])
    high4 = np.array([50, 29, 29])
    bin4_mask = cv2.inRange(img, low4, high4)
    lst.append(cv2.countNonZero(bin4_mask))

    low5 = np.array([51, 0, 0])
    high5 = np.array([60, 29, 29])
    bin5_mask = cv2.inRange(img, low5, high5)
    lst.append(cv2.countNonZero(bin5_mask))

    low6 = np.array([61, 0, 0])
    high6 = np.array([70, 29, 29])
    bin6_mask = cv2.inRange(img, low6, high6)
    lst.append(cv2.countNonZero(bin6_mask))

    low7 = np.array([71, 0, 0])
    high7 = np.array([80, 29, 29])
    bin7_mask = cv2.inRange(img, low7, high7)
    lst.append(cv2.countNonZero(bin7_mask))

    low8 = np.array([81, 0, 0])
    high8 = np.array([90, 29, 29])
    bin8_mask = cv2.inRange(img, low8, high8)
    lst.append(cv2.countNonZero(bin8_mask))

    low9 = np.array([91, 0, 0])
    high9 = np.array([100, 29, 29])
    bin9_mask = cv2.inRange(img, low9, high9)
    lst.append(cv2.countNonZero(bin9_mask))

    low10 = np.array([101, 0, 0])
    high10 = np.array([110, 29, 29])
    bin10_mask = cv2.inRange(img, low10, high10)
    lst.append(cv2.countNonZero(bin10_mask))

    low11 = np.array([111, 0, 0])
    high11 = np.array([120, 29, 29])
    bin11_mask = cv2.inRange(img, low11, high11)
    lst.append(cv2.countNonZero(bin11_mask))

    low12 = np.array([121, 0, 0])
    high12 = np.array([130, 29, 29])
    bin12_mask = cv2.inRange(img, low12, high12)
    lst.append( cv2.countNonZero(bin12_mask))

    low13 = np.array([131, 0, 0])
    high13 = np.array([140, 29, 29])
    bin13_mask = cv2.inRange(img, low13, high13)
    lst.append(cv2.countNonZero(bin13_mask))

    low14 = np.array([141, 0, 0])
    high14 = np.array([150, 29, 29])
    bin14_mask = cv2.inRange(img, low14, high14)
    lst.append(cv2.countNonZero(bin14_mask))

    low15 = np.array([151, 0, 0])
    high15 = np.array([160, 29, 29])
    bin15_mask = cv2.inRange(img, low15, high15)
    lst.append(cv2.countNonZero(bin15_mask))

    low16 = np.array([161, 0, 0])
    high16 = np.array([170, 29, 29])
    bin16_mask = cv2.inRange(img, low16, high16)
    lst.append(cv2.countNonZero(bin16_mask))

    low17 = np.array([171, 0, 0])
    high17 = np.array([179, 29, 29])
    bin17_mask = cv2.inRange(img, low17, high17)
    lst.append(cv2.countNonZero(bin17_mask))
